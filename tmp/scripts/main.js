...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)('.nav-list_item-language').on('click', function () {
    var elem = (0, _jquery2.default)('.nav-list-language-items');
    var displayAttr = elem.css("display");
    var seletedLang = (0, _jquery2.default)('#language-title').text();

    if (displayAttr === "none") {
      var seletedCheck = (0, _jquery2.default)('.nav-language_' + seletedLang);
  ...
  (0, _jquery2.default)('.language-item').on('click', function () {
    var thiselem = (0, _jquery2.default)(this);
    var elem = (0, _jquery2.default)('.nav-list-language-items');
